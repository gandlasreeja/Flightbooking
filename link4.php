...
$u=htmlentities($_POST['uname']);
$p=$_POST['pass'];
$e=$_POST['email'];
$m=$_POST['mobile'];
$sql = "insert into login1 values('$u','$p','$e','$m')";
...
@keyframes jump {
  ...
  50% {
    ...
    <body>
        <h1 style="margin:100px;color:beige;">Feelgood Airlines</h1>
        ...
        <img src="airline5.jpg" alt="">
            ...
            <a href="link3.html"><b>Feedback</b></a>
    ...
    <div id="login">
       <form action="" method="POST">
        ...
        <footer>
            <b style="color:white;">&copy; 2023 FeelGood Airlines. All rights reserved.</b>
        </footer>
    </body>
</html>
